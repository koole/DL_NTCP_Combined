...
filename_stratified_sampling_test_csv = (
    "stratified_sampling_test_hendrike.csv"  # input file
)
filename_stratified_sampling_full_csv = (
    "stratified_sampling_full_hendrike.csv"  # output file
)
...
seg_target_labels = [0] + [1] * len(
    data_preproc_config.structures_uncompound_list
)  # TASTE
