...
filename_stratified_sampling_test_csv = 'stratified_sampling_test_hendrike.csv'  # input file
filename_stratified_sampling_full_csv = 'stratified_sampling_full_hendrike.csv'  # output file
...
# DYSPHAGIA
features_dl = ['Xero_BSL_severe', 'Xero_BSL_moderate', 'Xero_BSL_Little', 'Xero_BSL_None', 'Loctum_Pharynx', 'Loctum_Larynx', 'Loctum_OC', 'Loctum_Other', 
               'BSLtox_grade0_1', 'BSLtox_grade2', 'BSLtox_grade3_4', 'T0', 'T1', 'T2', 'T3', 'T4', 'Tx', 'N0', 'N1', 'N2', 'N3', 'Nx', 
